...
public class FrasesMotivacionais {
		public static void main(String[] args) {
			...
			System.out.println("Exemplo Git frases motivacionais\n");
			System.out.println("1. O medo de cair não pode ser maior que a paixão de voar.");
			System.out.println("2. Se ainda venta não adianta varrer. Espere o momento certo de agir.");
			...
			System.out.println("7. Não desista. Quem desiste nunca vence, e os vencedores não desistem jamais.");
